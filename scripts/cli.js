...
const contractABI = require("../artifacts/contracts/SwapRouter.sol/SwapRouter.json").abi;

program
    .name("swap-router-cli")
    .description("CLI tool for SwapRouter smart contract")
    .version("1.0.0");
